...
public class Register extends javax.swing.JFrame {
    ...
    /**
     * Function to handle the register will be called in the register_button panel Will be called in the
     */
    /**
    ...
    private void register_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_register_buttonActionPerformed
        ...
        String email_check = email_field.getText().trim().toLowerCase();
        if (usersDB.checkStatus(email_check)) {
